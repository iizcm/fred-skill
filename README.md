...
cp -r fred ~/.hermes/skills/fred/

# Option B: Install directly from this repository's raw SKILL.md URL
<agent-cli> skills install https://raw.githubusercontent.com/iizcm/fred-skill/main/SKILL.md

# Option C: Clone this entire repo into your skills directory
git clone https://github.com/iizcm/fred-skill.git ~/.hermes/skills/fred/
```
...
```text
Use the fred skill to <describe your specific task here>
```
...
```text
Gunakan skill fred untuk <deskripsikan tugas spesifik Anda di sini>
```
